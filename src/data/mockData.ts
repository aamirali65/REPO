...
export const repositories: Repository[] = [
  {
    ...
    name: 'Kamao',
    owner: 'aamirali65',
    fullName: 'aamirali65/kamao',
    description: 'Flutter application for managing free-time work opportunities.',
    language: 'Dart',
    framework: 'Flutter',
    visibility: 'private',
  ...
  },
  {
    ...
    name: 'MockScreen',
    owner: 'aamirali65',
    fullName: 'aamirali65/mockscreen',
    description: 'Flutter UI experimentation project.',
    language: 'Dart',
    framework: 'Flutter',
    visibility: 'public',
    updatedAt: 'yesterday',
  ...
  },
  {
    ...
    owner: 'aamirali65',
    fullName: 'aamirali65/bundle_visualizer',
    description: 'Flutter bundle analysis utility.',
    language: 'Dart',
    framework: 'Flutter',
    visibility: 'public',
  ...
  },
  {
    ...
    name: 'Mekstak',
    owner: 'aamirali65',
    fullName: 'aamirali65/mekstak',
    description: 'Business and software platform.',
    language: 'TypeScript',
    framework: 'Next.js',
    visibility: 'private',
